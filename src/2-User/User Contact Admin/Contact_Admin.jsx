...
import Sidebar from '../User Sidebar/Sidebar.jsx'
      ...
      <div className="contact-admin-body">
        ...
        <div className="contact-admin-mail-contact">
          <div className="admin-mail">
            <h2>Whatsapp</h2>
            <a href="#" onClick={(e) => { e.preventDefault(); handleWhatsAppClick(); }}><img src={whatsappImage} alt="Whatsapp" /></a> 
          </div>
            
          <div className="admin-contact">
            <h2>Mail</h2>
            <a href="#" onClick={(e) => { e.preventDefault(); handleEmailClick(); }}><img src={gmailImage} alt="Mail" /></a>
          </div>
        </div>
